...
//		
	...
	public static void questao3_For() {
		...
		for (int i = 1; i <= 100; i++) {
		 ...
		 System.out.print("A Soma dos Numeros de 1 até 100 é: " + soma);
	...
	public static void questao6_Metodos() {
		...
		// SEU CÓDIGO AQUI
		 ...
		 System.out.println("Maior entre 10 e 20: " + encontrarMaior(10, 20));
		    System.out.println("Maior entre 5 e 3: " + encontrarMaior(5, 3));
		    System.out.println("Maior entre 7 e 7: " + encontrarMaior(7, 7));
		}
	...
	public static void questao10_MetodosFor() {
		...
		// SEU CÓDIGO AQUI
		 long resultado5 = calcularFatorial(5);
		    long resultado7 = calcularFatorial(7);

		    System.out.println("Fatorial de 5 = " + resultado5);
		    System.out.println("Fatorial de 7 = " + resultado7);
